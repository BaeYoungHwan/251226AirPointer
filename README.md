...
<video src="docs/0102 airproject/0102 airpointer.mp4"controls width="720">
airproject
</video>
...
│ │ └─ webcam.py # 웹캠 프레임 처리
│ ├─ hand/
│ │ └─ detector.py # MediaPipe 손 인식
│ ├─ mouse/
│ │ ├─ controller.py # 마우스 이동 / 클릭 / 스크롤
│ │ └─ gesture.py # 제스처 판별 로직
│ └─ config.py # 공통 설정값
└─ docs/
└─ 0102 airproject # 시연 영상
